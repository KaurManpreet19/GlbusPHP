                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="index " class="nav-link">Home Demo One</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="index-2 " class="nav-link">Home Demo Two</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="index-3 " class="nav-link">Home Demo Three</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" class="nav-link dropdown-toggle active">Team <i class='bx bx-chevron-down'></i></a>
                                            <ul class="dropdown-menu">
                                                <li class="nav-item">
                                                    <a href="team " class="nav-link active">Team</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="team-details " class="nav-link">Team Details</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="service-details " class="nav-link">Service Details</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="project-details " class="nav-link">Project Details</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            ...
                            <div class="bottom">
                                ...
                                <h3>
                                    <a href="team-details ">David Seek</a>
                                </h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            ...
                            <div class="bottom">
                                ...
                                <h3>
                                    <a href="team-details ">Angela Carter</a>
                                </h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            ...
                            <div class="bottom">
                                ...
                                <h3>
                                    <a href="team-details ">Moris James</a>
                                </h3>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            ...
                            <div class="bottom">
                                ...
                                <h3>
                                    <a href="team-details ">Victor James</a>
                                </h3>
                                <span>Member</span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            ...
                            <div class="bottom">
                                ...
                                <h3>
                                    <a href="team-details ">Jeninifer Karhan</a>
                                </h3>
                                <span>Member</span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            ...
                            <div class="bottom">
                                ...
                                <h3>
                                    <a href="team-details ">Jonny Erton</a>
                                </h3>
                                <span>Member</span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            <div class="top card-overlay">
                                <img src="assets/img/team/team7.jpg" alt="Team">
                            </div>
                            <div class="bottom">
                                <ul>
                                    <li>
                                ...
                                <h3>
                                    <a href="team-details ">Camellia Orhan</a>
                                </h3>
                                <span>Member</span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            ...
                            <div class="bottom">
                                ...
                                <h3>
                                    <a href="team-details ">Lopage Warhan</a>
                                </h3>
                                <span>Member</span>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="team-item">
                            <div class="top card-overlay">
                                <img src="assets/img/team/team9.jpg" alt="Team">
                            </div>
                            <div class="bottom">
                                <ul>
                                    <li>
                                ...
                                <h3>
                                    <a href="team-details ">Tom Penny</a>
                                </h3>
                                <span>Member</span>
                            </div>
                        </div>
