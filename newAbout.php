...
<html lang="zxx">
  ...
  <body>
    ...
    <!-- About -->
    <section class="about-area four  pt-100 pb-70">
      <div class="container">
        <div class="row aboutBoom  ">
            <div class="col-8">
                <h2>Twenty Years of Top Experience</h2>
                <hr class="hrD">
                <p>Aspire Business Solutions, as the name suggest, is a concept that has been build over time and with 15 years of enriching experience. It has managed to benchmark the highest quality of back office operations. </p>
                <p>Our ready to use methodology makes your business efficient, streamlined and vibrant. You are able to use your skilled resources for building the core elements of your business, simultaneously reducing cost on infrastructure and technology while saving on time and money.</p>
                <p>With our highly trained team of experts using various latest technology parameters, we are able to provide you with the most efficient and reliable back office operation.</p>
                <p>Aspire Business Solutions, a complete back office, remote and virtual office solution, provides businesses and CPA firms with any combination of services, space, and/or technology, completely eliminating the capital cost of owning or leasing a traditional office.</p>
            </div>
            <div class="col-4">
